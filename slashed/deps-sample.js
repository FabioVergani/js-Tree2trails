(w=>{
	const onceAt=(e,n,c)=>{const f=o=>{e.removeEventListener(n,f);c(o)};e.addEventListener(n,f);return f},
	drop=(o,n)=>{const e=o.currentTarget,i=n+'Handler';e.removeEventListener(n,e[i]);e[i]=null},
